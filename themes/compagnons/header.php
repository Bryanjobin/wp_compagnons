...
<head>
    ...
    <body>
    <header class="">
        <a href="#" aria-label="Accueil"><img class="logo" src="<?php echo $logo_src[0] ?>" alt="Logo Les Compagnons de la mise en valeur du patrimoine vivant"></a>
        ...
        <div class="header-container">
            <nav class="top_nav">
                <ul class="top_nav_menu">
                    <li class="top_nav_menu_item"><a class="top_nav_item_link" href=""><span class="top-nav-text">Événements à venir</span></a></li>
                    ...
                    <li class="top_nav_menu_item"><a class="top_nav_item_link" href="#"><span class="top-nav-text">Contact</span></a></li>
                    <li class="top_nav_menu_item"><a class="top_nav_item_link" href="#"><span class="top-nav-text">À propos</span></a></li>
                    <li class="top_nav_menu_item"><a class="top_nav_item_link" href="#"><span class="top-nav-text">FAQ</span></a></li>       
                </ul>
            </nav>
                ...
                <nav class="main_nav">
                    <div class="main_nav_menu--compagnons dropdown">
                        ...
                        <div class="main_nav_menu_submenu compagnons dropdown_content dropdown_content--animated">
                            <a class="main_nav_menu_submenu_link" href="#">
                    ...
                    <div class="main_nav_menu--festival dropdown">
                        ...
                        <div class="main_nav_menu_submenu dropdown_content">
                            <a class="main_nav_menu_submenu_link" href="" target="">
                            ...
                            <div class="main_nav_menu_submenu_link a-propos_link ">
                                ...
                                <p class="submenu-link a-propos_titre"> À propos</p>
                                    <ul class="main_nav_menu_submenu_link_btn_list">
                                        <li class="main_nav_menu_submenu_link_btn_list_item"><a class="main_nav_menu_submenu_link_btn_list_item_link" href="#"><span class="submenu-items">L'équipe du festival</span></a></li>
                                        <li class="main_nav_menu_submenu_link_btn_list_item"><a class="main_nav_menu_submenu_link_btn_list_item_link" href="#"><span class="submenu-items">Le prix Jocelyn Bérubé</span></a></li>
                                        <li class="main_nav_menu_submenu_link_btn_list_item"><a class="main_nav_menu_submenu_link_btn_list_item_link" href="#"><span class="submenu-items">La Bavarde: La bière officielle</span></a></li>
                                        <li class="main_nav_menu_submenu_link_btn_list_item"><a class="main_nav_menu_submenu_link_btn_list_item_link" href="#"><span class="submenu-items">Vers un festival responsable</span></a></li>
                                        <li class="main_nav_menu_submenu_link_btn_list_item"><a class="main_nav_menu_submenu_link_btn_list_item_link" href="#"><span class="submenu-items">Galerie médias</span></a></li>
                                    </ul>
                                </button>
                            </div>
                        </div>
